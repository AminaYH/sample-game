...
//    private SocketMainServerDAO dao;
    private DAOServerRMI dao;
...
//            dao = new SocketMainServerDAO();

        try {
            dao =new DAOServerRMI(this);
        } catch (RemoteException e) {
            throw new RuntimeException(e);
        }
//        dal = new UDPMainServerDAO();
        dao.start(listener=new MainServerDAOListener() {
            @Override
    ...
    protected void modelUpdated() {
        switch ((String) getModel().getProperty("Phase")) {
            ...
            case "GAMEOVER": {
                //do nothing
                dao.sendModelChanged(new DynamicGameModel(getFrame(),
